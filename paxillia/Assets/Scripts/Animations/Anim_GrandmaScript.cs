    ...
    IEnumerator OpenIntroDialog()
    {
        ...
        DialogManager.Instance.StartIngameDialog(new Dialog()
        {
            Messages = new List<Message>
            {
                ...
                new Message() { Character = Constants.CHAR_PAL, Text = "It's Pal, grandma, I've told you...", Duration = 5 },
                new Message() { Character = Constants.CHAR_GRANDMA, Text = "Na gut, Paul, doesn't messer...you kame to visit your old grossma? Gut boy!", Duration = 5 },
                ...
                new Message() { Character = Constants.CHAR_GRANDMA, Text = "Sure, and weil you're there, could you also helf me a bit with the garten?", Duration = 7 },
                new Message() { Character = Constants.CHAR_GRANDMA, Text = "You zee, mein Kratugarten is full of Unkraut!", Duration = 7 },
