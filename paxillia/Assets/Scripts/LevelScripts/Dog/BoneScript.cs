    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        DialogManager.Instance.StartDialog(new Dialog()
        {
            Messages = new List<Message>()
            {
                ...
                new Message() { Text = "Makes you think of Rolly. The dog has got his bone, but where is your ball? Maybe the doggy could sniff it out. You have the napkin you last cleaned Rolly with, after all." },
